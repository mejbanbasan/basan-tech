...
export const SERVICES_DATA: Service[] = [
  ...
  },
  {
    ...
    fullDescription: 'Off-the-shelf software rarely fits a growing company perfectly. At BasanTech, we engineer custom software solutions built around your exact business requirements. From automating manual back-office tasks to architecting complex multi-role enterprise management systems, we deliver secure, scalable software you completely own.',
    iconName: 'Cpu',
  ...
  },
  {
    ...
    fullDescription: 'When web apps lack the hardware access, raw compute performance, or offline security your business operations require, BasanTech builds dedicated desktop applications. Engineered with modern cross-platform technologies, our desktop software delivers native system integration, offline file handling, and lightning-fast local performance.',
    iconName: 'Laptop',
  ...
  },
  {
    ...
    fullDescription: 'Artificial intelligence is most powerful when deeply integrated into your daily business workflows. BasanTech builds tailored AI solutions: intelligent document analyzers, autonomous customer support agents, automated internal search over proprietary data (RAG), and smart prediction engines that save hundreds of staff hours every month.',
    iconName: 'Sparkles',
    badge: 'AI & Automation',
