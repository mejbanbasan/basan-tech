                      ...
                      <div className="pl-3 pr-1 py-1.5 flex flex-col gap-1 border-l-2 border-emerald-300 ml-3">
                        {SERVICES_DATA.map((service) => (
                          <button
                            ...
                            className="w-full text-left px-3 py-2 rounded-lg text-xs font-medium text-slate-700 hover:text-[#00976C] hover:bg-slate-50 transition-colors cursor-pointer flex items-center justify-between"
                          >
                        ...
                        <button
                          ...
                          className="w-full text-left px-3 py-2 rounded-lg text-xs font-semibold text-[#00976C] hover:bg-emerald-50/60 transition-colors cursor-pointer flex items-center justify-between mt-1 pt-1.5 border-t border-slate-100"
                        >
