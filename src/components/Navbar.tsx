        ...
        <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 px-3.5 py-1.5 text-xs font-semibold rounded-full transition-all duration-150 cursor-pointer ${
                        currentPage === 'services' || currentPage === 'service-detail'
                          ...
                          : 'text-slate-700 hover:text-[#022A4E] hover:bg-slate-100'
                      }`}
                    >
                      <span>{link.label}</span>
                      <ChevronDown className={`w-3 h-3 transition-transform duration-200 ${servicesDropdownOpen ? 'rotate-180 text-emerald-400' : 'text-slate-400'}`} />
                    </button>
                      ...
                      <div className="absolute top-full left-0 w-96 pt-2 z-50">
                        <div className="rounded-2xl p-3 shadow-xl border border-slate-200 bg-white backdrop-blur-xl space-y-1">
                          <div className="px-3 py-1.5 mb-1 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-semibold text-[#00976C] bg-emerald-50 px-2 py-0.5 rounded-full">
                              Expert Delivery
                            </span>
                          </div>
                          ...
                          <div className="grid grid-cols-1 gap-1 max-h-[380px] overflow-y-auto pr-1">
                            {SERVICES_DATA.map((service) => (
                              <button
                                ...
                                className="w-full flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 text-left transition-colors group cursor-pointer border border-transparent hover:border-slate-200"
                              >
                                <div className="p-2 rounded-lg bg-slate-100/90 border border-slate-200 group-hover:border-[#00976C] transition-colors shrink-0">
                          ...
                          <div className="mt-2 pt-2 border-t border-slate-100 px-1">
                            ...
                            >
                              <span>Explore All Services &amp; Tech Stacks</span>
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-bold text-white bg-[#022A4E] hover:bg-[#00976C] rounded-full transition-all duration-200 shadow-xs cursor-pointer group"
            >
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100">
              <button
                ...
                className="w-full py-3 text-center text-xs font-bold text-white bg-[#022A4E] hover:bg-[#00976C] rounded-full flex items-center justify-center gap-1.5 transition-colors shadow-xs cursor-pointer"
              >
