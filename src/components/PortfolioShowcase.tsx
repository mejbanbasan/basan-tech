...
export const PortfolioShowcase: React.FC<PortfolioShowcaseProps> = ({ onNavigate, limit }) => {
  ...
  return (
    <section id="portfolio-section" className="py-24 bg-zinc-50 border-b border-zinc-200">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-zinc-600 text-base sm:text-lg leading-relaxed">
              Explore production platforms built by Basan Tech. Every project features custom engineering, responsive design, and verified live platform links.
            </p>
          </div>
          ...
          {limit && (
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-semibold text-zinc-800 hover:text-zinc-950 bg-white hover:bg-zinc-100 border border-zinc-300 transition-colors shrink-0 shadow-2xs cursor-pointer"
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-medium transition-all cursor-pointer ${
                selectedFilter === f.id
                  ...
                  : 'bg-white text-zinc-600 hover:text-zinc-950 hover:bg-zinc-100 border border-zinc-200 shadow-2xs'
              }`}
            >
              {f.label}
            </button>
            ...
            <div className="px-6 py-4 bg-zinc-50 border-t border-zinc-200 flex flex-col sm:flex-row items-center justify-between gap-3 sticky bottom-0 z-20">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-6 py-2.5 rounded-full text-xs font-semibold text-white bg-zinc-950 hover:bg-zinc-800 transition-colors flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
                >
