                  ...
                  {study.liveUrl && (
                    <div className="absolute top-4 right-4">
                      <a
                        ...
                        className="px-3 py-1.5 min-h-[44px] rounded-full bg-white/95 hover:bg-[#00976C] text-slate-800 hover:text-white backdrop-blur-md transition-all inline-flex items-center gap-1 shadow-xs text-[11px] font-semibold group/live"
              ...
              <div className="flex items-center gap-2">
                {activeModalStudy.liveUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3.5 py-2 min-h-[44px] rounded-full text-xs font-semibold text-white bg-zinc-950 hover:bg-zinc-800 transition-colors shadow-2xs"
                  >
                ...
                <button
                  ...
                  className="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg bg-white border border-zinc-200 hover:bg-zinc-100 text-zinc-500 hover:text-zinc-950 transition-colors cursor-pointer"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
                ...
                <div className="absolute bottom-6 left-6 right-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                  ...
                  {activeModalStudy.liveUrl && (
                    <a
                      ...
                      className="px-4 py-2.5 min-h-[44px] rounded-full text-xs font-semibold bg-white text-zinc-950 hover:bg-zinc-100 transition-colors shrink-0 inline-flex items-center gap-1.5 shadow-md self-start sm:self-auto"
                    >
